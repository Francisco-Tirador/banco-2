    ...
    <div className="max-w-sm mx-auto w-full md:w-1/2 my-auto px-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          type="text"
          className="mb-5 bg-gray-100 border pr-28 border-gray-100 text-gray-900 text-sm rounded-lg block w-full p-2.5"
          ...
          <div className="absolute bg-white w-full top-11 rounded-b-md">
            <ul className="px-3">
              {optionsFilter.map((o, index) => (
                <li
                  key={index}
                  className="px-2 hover:bg-green-300 cursor-pointer"
      ...
      <input
        type="text"
        className="mb-5 bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed"
        value={userSearch?.nombre || ""} 
        disabled
      />
      <input
        type="text"
        className="mb-5 bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed"
        value={userSearch?.apellidoPaterno || ""} 
        disabled
      />
      <input
        type="text"
        className="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed"
        value={userSearch?.apellidoMaterno || ""} 
        disabled
      />
    </div>
  );
