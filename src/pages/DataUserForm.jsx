   ...
   return (
      <div className=" w-full min-h-screen flex flex-wrap">
         ...
         <form onSubmit={handleSubmit(handleSubmitData)} className="bg-gray-200 w-[80%] overflow-hidden  p-3 flex flex-wrap rounded-lg m-auto h-auto">
            {listar ? <Formulario handleToggleListar={handleToggleListar} users={users} setUserSearch={setUserSearch} userSearch={userSearch} /> : <TableUsers handleToggleListar={handleToggleListar} users={users} />}
